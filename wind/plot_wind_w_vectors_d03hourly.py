...
wind_hist_file = '/Users/evagnegy/Desktop/CanESM2_WRF_Eval/gridded_model_data/means/wind_d03_mean_hist.nc'
...
def plot_map(wspd,wdir,cmap,vmin,vmax,xlabel,fig_name,dx,dy,lons,lats):
    ...
    ax1.quiver(lons, lats, dx, dy,color='k',angles=270-wdir, width=0.003, scale=60,transform=ccrs.PlateCarree(),pivot='mid')
