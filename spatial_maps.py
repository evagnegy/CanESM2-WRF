...
def plot_bias(eccc_bias,bch_bias,noaa_bias,fig_name,title,seas=None):
...
# =============================================================================
    ...
    if variable != "wind":
        ...
        df_allstations = pd.concat([abs(eccc_bias),abs(noaa_bias)])

    avg_allstations = round(df_allstations.mean()/divide,2)
    
    plt.title(title + ', mean absolute bias: ' + str(avg_allstations),fontsize=20)
    ...
    #plt.savefig('/Users/evagnegy/Desktop/CanESM2_WRF_Eval/figures/spatial_maps/bias/' + fig_name + '_' + variable + '_bias.png',bbox_inches='tight')
#%% annual
plot_bias(wrf_bias_eccc,wrf_bias_bch,wrf_bias_noaa,'canesm2_wrf_d03_annual', 'CanESM2-WRF D03')
plot_bias(wrf_bias_eccc_d02,wrf_bias_bch_d02,wrf_bias_noaa_d02,'canesm2_wrf_d02_annual', 'CanESM2-WRF D02')
plot_bias(raw_bias_eccc,raw_bias_bch,raw_bias_noaa,'canesm2_raw_annual', 'CanESM2')
plot_bias(rcm_bias_eccc,rcm_bias_bch,rcm_bias_noaa,'canrcm4_annual', 'CanRCM4')
if variable != "wind":
