...
def calculate_compound_event():
    ...
    if period == "hist":
        ...
        if fut_type == "abs":
            ...
            count_event_peryear_ANN_delta = np.mean(count_event_peryear_ANN_fut,axis=0)-np.mean(count_event_peryear_ANN_hist,axis=0)
            count_event_peryear_MAM_delta = np.mean(count_event_peryear_MAM_fut,axis=0)-np.mean(count_event_peryear_MAM_hist,axis=0)
            count_event_peryear_JJA_delta = np.mean(count_event_peryear_JJA_fut,axis=0)-np.mean(count_event_peryear_JJA_hist,axis=0)
            count_event_peryear_SON_delta = np.mean(count_event_peryear_SON_fut,axis=0)-np.mean(count_event_peryear_SON_hist,axis=0)
            count_event_peryear_DJF_delta = np.mean(count_event_peryear_DJF_fut,axis=0)-np.mean(count_event_peryear_DJF_hist,axis=0)
            ...
            return(ttest_ANN.pvalue,ttest_MAM.pvalue,ttest_JJA.pvalue,ttest_SON.pvalue,ttest_DJF.pvalue,count_event_peryear_ANN_delta,count_event_peryear_MAM_delta,count_event_peryear_JJA_delta,count_event_peryear_SON_delta,count_event_peryear_DJF_delta)
...
def plot_compound_events(gridded_data,pvalue,seas,vmin,vmax):
    ...
    if period != "hist":
        plt.savefig('/Users/evagnegy/Desktop/CanESM2_WRF_Eval/figures/spatial_maps/compound_events/' + t_type + "_" + pr_type + "_" + period + "_base_" + base_period + "_" + seas,bbox_inches='tight')
    else:
        plt.savefig('/Users/evagnegy/Desktop/CanESM2_WRF_Eval/figures/spatial_maps/compound_events/' + t_type + "_" + pr_type + "_" + period + "_" + seas,bbox_inches='tight')
...
if period == "hist":
    ...
    pvalue_ANN,pvalue_MAM,pvalue_JJA,pvalue_SON,pvalue_DJF,count_event_peryear_ANN,count_event_peryear_MAM,count_event_peryear_JJA,count_event_peryear_SON,count_event_peryear_DJF = calculate_compound_event()
...
if period == "hist":
    ...
    vmin=0
    vmax=15
    plot_compound_events(np.array(count_event_peryear_ANN),None, "ANN",vmin*4,vmax*4)
    ...
    plot_compound_events(np.array(count_event_peryear_ANN),pvalue_ANN, "ANN",vmin,vmax)
