...
def get_var_ordered(szn,eccc,noaa):
    ...
    print(eccc_var_szn_avg)
    #wrf_var_szn_avg = pd.concat([eccc_var_szn_avg,bch_var_szn_avg,noaa_var_szn_avg])
    wrf_var_szn_avg = pd.concat([eccc_var_szn_avg,noaa_var_szn_avg])
...
obs_mam  = get_var_ordered("mam",eccc_obs,noaa_obs)
wrf_d03_mam  = get_var_ordered("mam",wrf_d03_eccc,wrf_d03_noaa)
wrf_d02_mam  = get_var_ordered("mam",wrf_d02_eccc,wrf_d02_noaa)
raw_mam  = get_var_ordered("mam",raw_eccc,raw_noaa)
rcm_mam  = get_var_ordered("mam",rcm_eccc,rcm_noaa)

obs_jja  = get_var_ordered("jja",eccc_obs,noaa_obs)
wrf_d03_jja  = get_var_ordered("jja",wrf_d03_eccc,wrf_d03_noaa)
wrf_d02_jja  = get_var_ordered("jja",wrf_d02_eccc,wrf_d02_noaa)
raw_jja  = get_var_ordered("jja",raw_eccc,raw_noaa)
rcm_jja  = get_var_ordered("jja",rcm_eccc,rcm_noaa)

obs_son  = get_var_ordered("son",eccc_obs,noaa_obs)
wrf_d03_son  = get_var_ordered("son",wrf_d03_eccc,wrf_d03_noaa)
wrf_d02_son  = get_var_ordered("son",wrf_d02_eccc,wrf_d02_noaa)
raw_son  = get_var_ordered("son",raw_eccc,raw_noaa)
rcm_son  = get_var_ordered("son",rcm_eccc,rcm_noaa)

obs_djf  = get_var_ordered("djf",eccc_obs,noaa_obs)
wrf_d03_djf  = get_var_ordered("djf",wrf_d03_eccc,wrf_d03_noaa)
wrf_d02_djf  = get_var_ordered("djf",wrf_d02_eccc,wrf_d02_noaa)
raw_djf  = get_var_ordered("djf",raw_eccc,raw_noaa)
rcm_djf  = get_var_ordered("djf",rcm_eccc,rcm_noaa)
...
def plot_all_szn(model_mam_input,model_jja_input,model_son_input,model_djf_input,color,model_name,figname): 
    ...
    if variable == "t":
        ...
        plt.title('Daily mean wind speed: ' + model_name, fontsize=22)
...
plot_all_szn(wrf_d03_mam,wrf_d03_jja,wrf_d03_son,wrf_d03_djf,'C0','CanESM2-WRF D03','wrf_d03_allszn')
plot_all_szn(wrf_d02_mam,wrf_d02_jja,wrf_d02_son,wrf_d02_djf,'C1','CanESM2-WRF D02','wrf_d02_allszn')
plot_all_szn(raw_mam,raw_jja,raw_son,raw_djf,'C2','CanESM2','raw_allszn')
plot_all_szn(rcm_mam,rcm_jja,rcm_son,rcm_djf,'C3','CanRCM4','rcm_allszn')
